        ...
        {loading ? (
            ...
            <div className="space-y-4">
                ...
                {teamScores.map((team, index) => (
                    <div key={team.team_name} className={`flex items-center p-4 rounded-3xl border-2 transition-all ${index === 0 ? 'bg-yellow-900/20 border-yellow-500 shadow-[0_0_20px_rgba(234,179,8,0.2)]' : 'bg-[#090812] border-gray-800'}`}>
                        ...
                        <div className="text-right">
                            <span className={`font-['Bebas_Neue'] text-4xl ${index === 0 ? 'text-yellow-400 drop-shadow-[0_0_10px_rgba(234,179,8,0.8)]' : 'text-purple-400 drop-shadow-[0_0_5px_rgba(168,85,247,0.5)]'}`}>
                                {team.period_points}
                            </span>
            ...
            <div className="space-y-4">
              {users.map((user, index) => {
                  ...
                  return (
                    <div key={user.user_id} className={`flex items-center p-4 rounded-3xl border-2 transition-all ${isMe ? 'bg-yellow-900/10 border-yellow-500/50' : 'bg-[#090812] border-gray-800 hover:border-gray-600'}`}>
                      <div className="w-10 text-2xl font-['Bebas_Neue'] text-gray-500">{index + 1}</div>
                      <img 
                      ...
                      <div className="text-right">
                        <span className="font-['Bebas_Neue'] text-3xl text-blue-400 drop-shadow-[0_0_5px_rgba(59,130,246,0.5)]">
                            {user.period_points}
                        </span>
